"""Bài Tập 4: Privacy Agent và conditional routing hoàn chỉnh."""
...
def check_routing(state: State) -> list[Send]:
    ...
    if any(
        ...
        for kw in ["data", "privacy", "gdpr", "dữ liệu", "rò rỉ"]
    ):
...
Hãy phân tích nghĩa vụ bảo vệ dữ liệu, quyền riêng tư, thông báo vi phạm,
quyền của chủ thể dữ liệu và chế tài có thể áp dụng. Nêu rõ khi kết luận
phụ thuộc vào quốc gia hoặc phạm vi áp dụng của GDPR. Trả lời dưới 180 từ."""
...
def aggregate_results(state: State) -> dict:
    ...
    llm = get_llm().bind(max_tokens=500)
...
Chỉ trả lời theo đúng 4 mục sau:
1. Pháp lý: tối đa 2 gạch đầu dòng.
2. Thuế: tối đa 2 gạch đầu dòng.
3. Quyền riêng tư: tối đa 2 gạch đầu dòng.
4. Hành động ngay: tối đa 3 gạch đầu dòng.

Toàn bộ câu trả lời tối đa 220 từ. Không viết lời mở đầu, ngày tháng, kính gửi,
hoặc lặp lại nội dung."""
