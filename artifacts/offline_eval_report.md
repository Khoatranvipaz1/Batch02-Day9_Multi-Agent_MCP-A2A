...
| parallel_trace_aggregation | PASS | 48.8 | parallel overlap=2; trace/context/depth propagated; aggregation passed |
| specialist_failure_fallback | PASS | 13.6 | tax failure degraded gracefully; compliance and aggregation completed |
